...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{Kovács András}
\newcommand{\vikkonzulens}{Dr.~Iváncsy Szabolcs}
\newcommand{\vikcim}{Intelligens épület felügyeleti rendszer tervezése mirokontrollerrel}
