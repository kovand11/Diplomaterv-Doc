...
Napi 20 nyitás/csukás-t feltételezve, az üzemidõ $T_2 = \frac{1200 mAh}{I_{tot} + 20*\frac{200mAs}{24 h}} = 7891 h$ ami 366 napot jelent.
...
Ha minden elõfeltétel teljesül, akkor az eszköz indulás után leolvassa a kapcsoló állapotát, felcsatlakozik a beállított szerverre és elküld GET paraméterként elküldi leolvasott értéket. Ezután mélyalvásba teszi magát, amibõl csak a kapcsoló újboli állapotváltozása tudja felébreszteni.

%----------------------------------------------------------------------------
\section{Prototípus}
%----------------------------------------------------------------------------

Az elsõként elkészült környezeti szenzor élesztése alatt szerzett tapasztalatok birtokában ezen prototípus elkészítése jóval egyszer\H{u}bbnek bizonyult. Megemlíthetõ, hogy a hõlégfúvó láthatóan károsította a nyomtatott áramkört, egy helyen a forrasztásgátló maszk is elt\H{u}nt. Az ESP8285 az adatlapja szerint 0.3 - 1 másodperc alatt képes a modemre felkapcsolódni, a tapasztalat az mutatta, hogy inkább a felsõ határ az igaz. Az 1.18T - 1.24T erõsség\H{u} mágnesnek hozzávetõlegesen 8mm - 10mm kellet a kapcsoló aktiválásához.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=150mm, keepaspectratio]{figures/opendetector-proto.png}
	\caption{Az elkészült nyitásérzékelõ áramkör (lesz jobb fotó)} 
\end{figure}
